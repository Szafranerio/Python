...
tomato_png = PhotoImage(
    file='/Users/bartlomiejszafran/Desktop/GitHub/Python/100Days_Python_Projects/data/Day028_Pomodoro/tomato.png')
...
start_button = Button(text='Start', command=start_timer,
                      highlightthickness=0, borderwidth=0, highlightbackground=YELLOW)
